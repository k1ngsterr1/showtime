...
export const AchievementGallery: React.FC<IAchivementsGalleryProps> = ({ achievements }) => {
	return (
		<>
			<Swiper slidesPerView={9} width={100} spaceBetween={48} className={styles.swiper}>
				<SwiperSlide>
