...
import { AdminOnlineRating } from '@features/AdminRating/online'
					...
					<div className={styles.client__main}>
						...
						<div className={styles.client__main__functional}>
							<div className={styles.client__main__functional__header_service}>
								<h1 className={styles.client__main__functional__header_heading}>Online Рейтинг</h1>
								<ParagraphReact
									text="Заполните все поля, чтобы добавить новый online рейтинг"
									paragraphType="white"
									margin="mt-2"
								/>
							</div>
